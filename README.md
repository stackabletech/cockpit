...
For detailed Helm chart documentation, see [deploy/helm/stackable-cockpit/README.md](./deploy/helm/stackable-cockpit/README.md).
...
```bash
# Build the image
docker build . -f docker/Dockerfile --build-arg TARGETARCH=x86 --build-arg VERSION=0.0.0-dev -t stackable-cockpit:0.0.0-dev

# Run the container
docker run -p 3000:3000 stackable-cockpit:0.0.0-dev
```
