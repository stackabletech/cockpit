 ...
 *  Controlled by `STACKABLE_UI_TEXT_PREVIEW_BYTES`. Default: 262144 (256 KiB).
...
export const textPreviewBytes =
  parseInt(env.STACKABLE_UI_TEXT_PREVIEW_BYTES ?? '', 10) || 256 * 1024;

/** Maximum bytes fetched when streaming an image file preview.
 *  Controlled by `STACKABLE_UI_IMAGE_PREVIEW_BYTES`. Default: 5242880 (5 MiB).
...
export const imagePreviewBytes =
  parseInt(env.STACKABLE_UI_IMAGE_PREVIEW_BYTES ?? '', 10) || 5 * 1024 * 1024;

/** Maximum bytes fetched when streaming a PDF file preview.
 *  Controlled by `STACKABLE_UI_PDF_PREVIEW_BYTES`. Default: 26214400 (25 MiB).
