<script lang="ts">
  ...
  import { setStorageRouteBase, EMBED_STORAGE_ROUTES } from '$lib/storage/route-context.js';
  ...
  setStorageRouteBase(EMBED_STORAGE_ROUTES);
  ...
  const isConnectionsRoute = $derived(page.url.pathname.startsWith('/embed/storage/connections'));
</script>
